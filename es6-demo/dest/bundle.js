...
dispatch.on("/default", _handler2["default"].detail);
...
var _data = [{ name: 'xxxxx' }, { name: 'xxxxx4' }, { name: 'xxxxxe' }, { name: 'xxxxx2' }, { name: 'xxxxx1' }, { name: 'xxxxx1' }];

function render() {
	(0, _dom2['default'])('#page').innerHTML = '' + _data.map(function (item) {
...
function render(params) {
	alert(params.id1);
	alert(params.id2);
	(0, _dom2['default'])('#page').innerHTML = tpl;
}
